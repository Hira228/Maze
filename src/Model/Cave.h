...
public:
  cave_type cave_;
  Cave();
  Cave(const std::size_t &, const std::size_t &, const std::size_t &l_d,
       const std::size_t &l_u, const std::size_t &b_d, const std::size_t &b_u,
       const value_type & = 49);
  ...
  void SetParameters(const value_type &rows, const value_type &cols,
